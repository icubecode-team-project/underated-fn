      ...
      <div className="max-w-7xl mx-auto px-8 py-20 flex flex-col items-center">
        ...
        <div className="flex justify-center flex-wrap gap-6 mb-4 text-sm">
          <a href="#" className="hover:text-white flex items-center">
            Help <FaArrowUpRightFromSquare className="ml-1 text-xs" />
          </a>
          <a href="#" className="hover:text-white flex items-center">
            Site Index <FaArrowUpRightFromSquare className="ml-1 text-xs" />
          </a>
          <a href="#" className="hover:text-white flex items-center">
            UnderatedPro <FaArrowUpRightFromSquare className="ml-1 text-xs" />
          </a>
          <a href="#" className="hover:text-white flex items-center">
            Box Office Mojo <FaArrowUpRightFromSquare className="ml-1 text-xs" />
          </a>
          <a href="#" className="hover:text-white flex items-center">
            License Underated Data <FaArrowUpRightFromSquare className="ml-1 text-xs" />
          </a>
        </div>
        ...
        <div className="flex justify-center flex-wrap gap-6 mb-4 text-sm">
          ...
          <a href="#" className="hover:text-white flex items-center">Your Ads Privacy Choices</a>
        </div>

        <p className="mb-2 text-sm text-gray-400 flex items-center justify-center gap-2">
          an <img src={Logo} alt="Underated Logo" className="w-6 h-6" /> Company
        </p>
